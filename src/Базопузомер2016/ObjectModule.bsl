	...
	ИначеЕсли Лев(МетаМетка, 3) = "Рег" Тогда
		...
		Если МетаМетка = "РегС" Тогда
			...
			Если Метаданные.РегистрыСведений[ИмяТаблицы].РежимЗаписи = Метаданные.СвойстваОбъектов.РежимЗаписиРегистра.ПодчинениеРегистратору Тогда
				ПолеСуммирования = "Регистратор";
			ИначеЕсли Метаданные.РегистрыСведений[ИмяТаблицы].ПериодичностьРегистраСведений <> Метаданные.СвойстваОбъектов.ПериодичностьРегистраСведений.Непериодический Тогда
				ПолеСуммирования = "Период";
			ИначеЕсли Метаданные.РегистрыСведений[ИмяТаблицы].Измерения.Количество() > 0 Тогда
				//КоллекцияПолей = Метаданные.РегистрыСведений[ИмяТаблицы].Измерения;
				//Для Каждого Поле Из КоллекцияПолей Цикл
				//	Поле
				//КонецЦикла;
				ПолеСуммирования = Метаданные.РегистрыСведений[ИмяТаблицы].Измерения[0].Имя;
			ИначеЕсли Метаданные.РегистрыСведений[ИмяТаблицы].Ресурсы.Количество() > 0 Тогда
				ПолеСуммирования = Метаданные.РегистрыСведений[ИмяТаблицы].Ресурсы[0].Имя;
			ИначеЕсли Метаданные.РегистрыСведений[ИмяТаблицы].Реквизиты.Количество() > 0 Тогда
				ПолеСуммирования = Метаданные.РегистрыСведений[ИмяТаблицы].Реквизиты[0].Имя;
			Иначе
